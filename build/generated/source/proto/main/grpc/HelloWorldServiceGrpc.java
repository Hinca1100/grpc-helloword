...
public final class HelloWorldServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<Hello.HelloRequest,
      Hello.HelloResponse> getHelloMethod;
  ...
  public static io.grpc.MethodDescriptor<Hello.HelloRequest,
      Hello.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<Hello.HelloRequest, Hello.HelloResponse> getHelloMethod;
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void hello(Hello.HelloRequest request,
  ...
  public static final class HelloWorldServiceBlockingStub
    ...
    /**
     */
    public Hello.HelloResponse hello(Hello.HelloRequest request) {
  ...
  public static final class HelloWorldServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Hello.HelloResponse> hello(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((Hello.HelloRequest) request,
              (io.grpc.stub.StreamObserver<Hello.HelloResponse>) responseObserver);
          break;
        default:
